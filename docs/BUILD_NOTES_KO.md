...
하나의 패치 소스(`ead1e2b5e`)에서 UI를 한 번 빌드하고 linux-x64/linux-arm64/linux-arm 백엔드를 순차 publish했습니다. 동일 Dockerfile/buildx 흐름으로 amd64·arm64·armv7 OCI 이미지를 만들었습니다. 아키텍처별 소스 패치는 없습니다.
